...
If you want to follow this data collecting and modelling, use script [NY_times.R](https://github.com/RRisto/NYT-scraping-and-Naive-Bayes/blob/master/NY_times.R "https://github.com/RRisto/NYT-scraping-and-Naive-Bayes/blob/master/NY_times.R")